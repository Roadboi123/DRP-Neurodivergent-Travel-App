...
# Station-level "Drilling & Works" (platform noise) and "Event & Crowds" (station
# crowding) cards were removed: a delayed line now produces a single consolidated
# "Line Delays" warning that already covers both effects, so they no longer surface
# as their own cards.
